...
def axis_quat_front(qw,qx,qy,qz):
    ...
    return rx/norm,ry/norm,rz/norm
    #return axis_vec_normalize(rx,ry,rz) prevent jit in jit
def highaxis_quat_front(qw,qx,qy,qz):
    x=1
    y=0
    z=0
    tx,ty,tz = axis_vec_cross( qx*2,qy*2,qz*2, x,y,z )
...
front = highaxis_quat_front(w,x,y,z)
front = axis_quat_front(w,x,y,z)
front = low_axis_quat_front(w,x,y,z)
...
#spd differs of ,,whos first. all same. as py.. yeah YOU DID PY FUNC TEST!
#see -numba, says, jit in jit ok.samespeed since all compiled and sealed.
# =======high
# 0.08377242088317871
# =======low
# 0.08280706405639648

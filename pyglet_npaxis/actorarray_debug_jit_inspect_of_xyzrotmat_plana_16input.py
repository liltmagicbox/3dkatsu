...
#this cannot hold input_array. but assigns new array.
@nb.jit(nopython=True , parallel = True)
def axis_xyzmat_rotmat(m0,m1,m2,m3,m4,m5,m6,m7,m8,m9,m10,m11,m12,m13,m14,m15, x,y,z):
    #https://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles
    # x,y,z means Rx,Ry,Rz. thats all.,not! yaw (Z), pitch (Y), roll (X)
...
os = np.zeros(NN).astype('float32')

print('----- rotmay xyz',NN)
t=time()
rotmat = axis_xyzmat_rotmat.py_func(zs,zs,zs,zs, zs,zs,zs,zs, zs,zs,zs,zs, zs,zs,zs,zs, x,y,z)
#print(rotmat)
...
rotmat = axis_xyzmat_rotmat(zs,zs,zs,zs, zs,zs,zs,zs, zs,zs,zs,zs, zs,zs,zs,zs, x,y,z)
t=time()
rotmat = axis_xyzmat_rotmat(zs,zs,zs,zs, zs,zs,zs,zs, zs,zs,zs,zs, zs,zs,zs,zs, x,y,z)
#print(rotmat)
#print(rotmat.shape)
...
print(type(rotmat[0]))
print(rotmat[0].dtype) #see float64..

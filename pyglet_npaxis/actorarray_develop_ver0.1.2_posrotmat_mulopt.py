...
def axis_tr_posrotmat(colmat, Tx,Ty,Tz, Rx,Ry,Rz):
    ...
    # colmat[0] = cy*cz
    # colmat[1] = -cxsz + sx*sycz
    # colmat[2] = sxsz + cx*sycz
    # colmat[3] =  Tx    
    # colmat[4] = cy*sz
    # colmat[5] = cx*cz + sxsz*sy
    # colmat[6] = -sx*cz + cxsz*sy
    # colmat[7] = Ty     
    # colmat[8] = -sy
    # colmat[9] = sx*cy
    # colmat[10] = cx*cy
...
#dummy reset ,, 82/26 -> 85/35
# with sleep without dummy 64 27
# with sleep with dummy 68 33

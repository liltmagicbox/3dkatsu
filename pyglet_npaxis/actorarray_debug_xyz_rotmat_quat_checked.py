...
def axis_rotmat_modelmat(pos,rotmat,scale):
...
y = np.random.rand(1)
z = np.random.rand(1)
print('-'*10, 'rotate x,y,z')
print(x)
print(y)
print(z)

print('-'*10, 'rotmat by xyz')
rotmat = axis_xyz_rotmat(x,y,z)
print(rotmat)
print('----')

print('-'*10, 'quat by xyz')
quat = axis_xyz_quat(x,y,z)
print(quat,'quat')

print('-'*10, 'rotmat by quat')
x,y,z,w = quat

...
pw,px,py,pz = 0,1,0,0 #vector
qw,qx,qy,qz = w,x,y,z #quat
rw,rx,ry,rz = axis_quat_rev(w,x,y,z) #rev of quat

#means, vector p(0,x,y,z) to p' .. rotated by q.
tw,tx,ty,tz = axis_quat_mul(pw,px,py,pz, rw,rx,ry,rz)
pr = axis_quat_mul(qw,qx,qy,qz, tw,tx,ty,tz )

print(w,x,y,z)
print(pr)
#(0.0, 0.516170507954538, 0.8038879363274418, -0.29552020666133955) from xyz(0.5,0.3,1)
#seems we did.
exit()

def axis_quat_front(w,x,y,z):
    1

...
import numpy as np
from np_modelmat import vec3,vpos,eye4,  mlookat,mortho,mperspective, mtrans,mscale,mrotx
import np_modelmat
...
class Actor:
    ...
    def get_matrix_model(self):
        ...
        mmodel = mtrans(self.pos)@mrotx(self.rotx)@mscale(self.scale)@mmodel
        #print(mmodel,'before')
        #mmodel = mscale(self.scale)@mmodel
        #print(mmodel,'after')
        #print(mscale(self.scale),'by')

        #mmodel = mtrans(self.pos)@mrotate(self.rotx)@mscale(self.scale)@mmodel
        return mmodel

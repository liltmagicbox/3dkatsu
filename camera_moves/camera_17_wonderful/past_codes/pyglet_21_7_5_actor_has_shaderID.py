...
class Actor:
    ...
    #def set_uniform_model(self):# it can return matrix.. shader free.
    #deprecated, over boundary access rule. see21.7.4. it will remained.

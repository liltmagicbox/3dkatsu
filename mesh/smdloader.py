...
class Mesh:
	...
	def atlas(cls, meshes, SIZE = 2048):
		...
		def save_atlas(channel, onlyone = False):
			cc=0
			mesh1 = meshes[0]
			w_before =0
			h_before =0
			...
			if onlyone: atlasname = f'{mesh1.modelname}_atlas.png'
			path = mesh1.path

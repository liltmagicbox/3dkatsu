#seems we cant use single buffer with glFlush. but instances asteroid did..
#i donno why but just use dbuffer. anyway we do need to single buffer.fine.
...
class Window:
    ...
    def run(self):
        ...
        glClearColor(0.5,0.82,0,1)
        glClear(GL_COLOR_BUFFER_BIT)
        glfwSwapBuffers(window)        

        glfwMakeContextCurrent(window)
        glClearColor(1,0.182,0,1)
        glClear(GL_COLOR_BUFFER_BIT)
        glFlush()

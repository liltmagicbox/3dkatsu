...
class Window:
    ...
    def __init__(self, windowname = 'a window'):
        ...
        #print(glfwGetMonitors())[<glfw.LP__GLFWmonitor object at 0x00000228D5740140>]
        monitor = glfwGetMonitors()[0]
        #print(glfwGetMonitorName(monitor))b'Generic PnP Monitor'
        glfwSetGamma(monitor, 0.8)
